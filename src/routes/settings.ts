...
export function settingsRoutes(
  ...
  const settingsController = new SettingsController(config, nodeApiService, s3Service);
  ...
  fastify.post(
    '/node/cloudflare/turnstile/configure',
    {
      schema: { tags: ['Settings'] },
    },
  ...
  fastify.post(
    '/node/cloudflare/turnstile/clear',
    {
      schema: { tags: ['Settings'] },
    },
